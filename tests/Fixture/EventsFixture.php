...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'Events_Contacts' => ['type' => 'index', 'columns' => ['contact_id'], 'length' => []],
            'Events_Rooms' => ['type' => 'index', 'columns' => ['room_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'Events_Contacts' => ['type' => 'foreign', 'columns' => ['contact_id'], 'references' => ['contacts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'Events_Rooms' => ['type' => 'foreign', 'columns' => ['room_id'], 'references' => ['rooms', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
