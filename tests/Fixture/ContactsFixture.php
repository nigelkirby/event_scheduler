...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'first_name' => ['type' => 'string', 'length' => 127, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'last_name' => ['type' => 'string', 'length' => 127, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2015-06-06 01:24:26',
            'modified' => '2015-06-06 01:24:26'
        ],
    ];
}
